...
1. **Screenshot 1:** NodeMCU serial output upon Wi-Fi and Blynk connection ![Alt text](`Screenshot_20250629_134754_Blynk IoT.jpg`).
2. **Screenshot 2:** Blynk dashboard with Switch (V0), Value Display (V1), and Gauge (V2) ![Alt text](`Screenshot_20250629_134757_Blynk IoT.jpg`).
3. **Demo Video:** [Watch the demo on YouTube]![Alt text]([https://www.youtube.com/your-video-link](https://www.youtube.com/watch?v=Y2iu5TG_uY4)).
